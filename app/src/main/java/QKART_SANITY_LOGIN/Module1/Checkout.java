...
public class Checkout {
        ...
        try {
             ...
             */
             ...
             addNewAddElement.click();
              ...
              WebElement addressinpuElement = driver.findElement(By.xpath("//textarea[@placeholder='Enter your complete address']"));
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            ...
            WebElement insufficientBalanceMessage = driver.findElement(By.xpath("//div[@id='notistack-snackbar']"));
            if(insufficientBalanceMessage.isDisplayed()){
                String text = insufficientBalanceMessage.getText();
                if(text.equalsIgnoreCase("You do not have enough balance in your wallet for this purchase")){
                    return true;
