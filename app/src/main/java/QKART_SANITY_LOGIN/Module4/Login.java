...
public class Login {
    ...
    public Boolean VerifyUserLoggedIn(String Username) {
        try {
            // Wait for the username label to be present
            WebElement username_label = new WebDriverWait(driver, 10)
            ...
            System.out.println("Exception while verifying user logged in: " + e.getMessage());
            return false;
        }
    }
